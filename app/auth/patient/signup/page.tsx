...
import type { PatientFormData, PatientSignUpResponse } from '../../../../types/patient';
...
export default function PatientSignUp(): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const data: PatientSignUpResponse = await res.json();
        ...
        <header className="auth-header">
          ...
          <div className="logo-section">
            ...
            <div className="title-section">
              ...
              <p className="auth-subtitle">Únete para una experiencia personalizada</p>
            </div>
          </div>
        </header>
