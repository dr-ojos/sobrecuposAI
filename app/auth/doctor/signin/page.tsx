...
import { DoctorData } from '../../../../types/auth';
...
export default function DoctorSignIn(): React.JSX.Element {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      if (res.ok) {
        // Guardar sesión de médico
        if (data.doctor) {
          localStorage.setItem('doctorSession', JSON.stringify(data.doctor));
        }
        router.push('/medico');
      } else {
      ...
      <div className="auth-card">
        ...
        <header className="auth-header">
          ...
          <div className="logo-section">
            ...
            <div className="title-section">
              <h1 className="auth-title">Acceso Médicos</h1>
              <p className="auth-subtitle">Inicia sesión con tu cuenta de médico</p>
            </div>
          </div>
        </header>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="input-group">
            <label className="input-label">Email médico</label>
            <input
              type="email"
              name="email"
