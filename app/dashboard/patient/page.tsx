...
// Extended interface for patient session data stored in localStorage
...
export default function PatientDashboard(): React.JSX.Element | null {
  ...
  useEffect(() => {
    ...
    const patientSession: string | null = localStorage.getItem('patientSession');
    if (patientSession) {
      try {
        const patientData: PatientSessionData = JSON.parse(patientSession);
  ...
  const handleActionCardClick = (action: () => void) => (event: MouseEvent<HTMLDivElement>): void => {
  ...
  const getUserDisplayName = (): string => {
    return patient.firstName || patient.name || 'Usuario';
  };
      ...
      <div className="dashboard-card">
        ...
        <header className="dashboard-header">
          <div className="user-info">
            ...
            <div className="user-details">
              <h1 className="user-name">¡Hola, {getUserDisplayName()}! 👋</h1>
        ...
        <div className="main-actions">
          <div 
            ...
            onClick={handleActionCardClick(handleStartChat)}
          >
