...
export async function PUT(req) {
  try {
    ...
    if (updateData.birthDate) {
      ...
      cleanData.Edad = calculateAge(updateData.birthDate);
    }
...
async function checkExistingWhatsAppUser(email, phone) {
  try {
...
async function sendWelcomeWhatsApp(userData, userId) {
  try {
