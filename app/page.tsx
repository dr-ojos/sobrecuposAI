...
import type { MousePosition, EspecialidadResponse } from '../types/homepage';
...
export default function Home(): React.ReactElement {
  ...
  const [chatExpanding, setChatExpanding] = useState<boolean>(false);
  ...
  // Función específica para el click del botón
  ...
  useEffect(() => {
    const fetchEspecialidades = async (): Promise<void> => {
      try {
        ...
        const data: EspecialidadResponse = await response.json();
