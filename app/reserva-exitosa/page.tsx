...
// Interface for reservation data extracted from URL parameters
...
type SearchParamKey = 'doctor' | 'specialty' | 'date' | 'time' | 'clinic' | 'patient' | 'transactionId' | 'amount';

// Interface for the loading component props
interface LoadingSpinnerProps {
  message?: string;
}

// Loading spinner component with proper typing
const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ message = "Cargando confirmación..." }) => (
...
function ReservaExitosaContent(): React.JSX.Element {
  const router = useRouter();
  const searchParams = useSearchParams();
  const [reservaData, setReservaData] = useState<ReservationData | null>(null);

  useEffect(() => {
    // Extract reservation data from URL parameters with proper typing
  ...
  // Function to format amount with proper typing
  const formatAmount = (amount: string): string => {
    const numericAmount = parseInt(amount, 10);
    return isNaN(numericAmount) ? amount : numericAmount.toLocaleString('es-CL');
  };

  // Function to generate doctor initials with proper typing
          ...
          <div className="appointment-details">
            <div className="doctor-section">
              <div className="doctor-avatar">
                {getDoctorInitials(reservaData.doctorName)}
              </div>
            ...
            <div className="appointment-info">
              ...
              <div className="info-row payment-row">
                ...
                <span className="info-value amount">${formatAmount(reservaData.amount)} CLP</span>
              </div>
            </div>
          </div>
...
// Fallback component for Suspense with proper typing
...
// Main page component with proper TypeScript typing
const ReservaExitosaPage: React.FC = () => {
  return (
