...
export default function PerfilMedico(): React.JSX.Element {
      ...
      if (res.ok) {
        ...
        if (finalPhotoURL && finalPhotoURL.includes('s3.') && finalPhotoURL.includes('amazonaws.com')) {
          try {
            ...
            if (photoRes.ok) {
              const photoData: ApiResponse = await photoRes.json();
        ...
        setDoctorData({
          ...
          Atiende: data.fields?.Atiende || 'Adultos',
  ...
  const handleImageUpload = async (event: ChangeEvent<HTMLInputElement>): Promise<void> => {
    ...
    try {
      ...
      const uploadData: ApiResponse = await uploadRes.json();
  ...
  const handleSave = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      const updateData: UpdateDoctorRequest = { 
        ...
        ...doctorData,
        Atiende: doctorData.Atiende === '' ? 'Adultos' : doctorData.Atiende as 'Adultos' | 'Niños' | 'Ambos'
      };
  ...
  const handleInputChange = (field: keyof DoctorFormData) => (
    ...
    setDoctorData(prev => ({ ...prev, [field]: e.target.value }));
  };
              ...
              <div className="form-grid">
                ...
                <div className="form-field">
                  ...
                  <select
                    ...
                    onChange={handleInputChange('Atiende')}
                    className="field-input"
                  >
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleInputChange('RSS')}
                    className="field-input"
                    placeholder="123456"
                    maxLength={8}
                  />
            ...
            <div className="form-card">
              ...
              <div className="form-field">
                ...
                <textarea
                  ...
                  onChange={handleInputChange('Experiencia')}
